...
import type { ParcelFeature, SubdivisionResult } from "../types/mapa";

/**
 * Verifica si una parcela tiene permitido subdividirse
 */
export function canSubdivide(parcelFeature: ParcelFeature | null | undefined): SubdivisionResult {
...
if (typeof window !== 'undefined') {
  (window as unknown as { SubdivisionBlocker: unknown }).SubdivisionBlocker = { canSubdivide };
}
