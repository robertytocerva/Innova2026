import type { ParcelFeatureCollection } from "../types/mapa";

export const michoacanParcels: ParcelFeatureCollection = {
  ...
  features: [
    ...
    // 2 parcels with dirty geometry issues
    {
      ...
      properties: {
        ...
        historialDeforestacion: [],
        geometryIssues: [
          { tipo: 'auto_interseccion', descripcion: 'El polígono se cruza a sí mismo en los vértices 2 y 4.', severidad: 'alta', autoReparable: false }
        ],
        subdivisionBloqueada: false,
        parentId: null,
        ndviPromedio: 0.75,
    ...
    },
    {
      ...
      properties: {
        ...
        historialDeforestacion: [],
        geometryIssues: [
          { tipo: 'area_minima', descripcion: 'La forma es demasiado irregular y podría ser un error de digitalización.', severidad: 'media', autoReparable: false },
          { tipo: 'traslape', descripcion: 'Traslape detectado con parcela colindante MCH-005', severidad: 'alta', autoReparable: false }
        ],
        subdivisionBloqueada: false,
        parentId: null,
        ndviPromedio: 0.80,
